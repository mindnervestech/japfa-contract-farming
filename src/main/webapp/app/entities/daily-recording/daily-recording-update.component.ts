...
export class DailyRecordingUpdateComponent implements OnInit {
  ...
  updateForm(dailyRecording: IDailyRecording) {
    this.editForm.patchValue({
      ...
      materialCode: dailyRecording.materialCode,
      chiksSamplingWeight: dailyRecording.chiksSamplingWeight,
      chiksCondition: dailyRecording.chiksCondition,
  ...
  private createFromForm(): IDailyRecording {
    return {
      ...
      chiksSamplingWeight: this.editForm.get(['chiksSamplingWeight']).value,
      chiksCondition: this.editForm.get(['chiksCondition']).value,
